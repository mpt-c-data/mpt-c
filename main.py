...
parser.add_argument("--input_csv_path", type=str, default='./data/INPUT.csv',
                    help='Path to the input csv ')
parser.add_argument('--output_csv_path', type= str, default='./data/ANT.csv', 
                    help='The output ground truth of the variable')
parser.add_argument('--learning_rate', type=float, default=0.0001,
                    help='The learning_rate of the optimizer')
parser.add_argument('--varaible_name', type=str, default='ANT',
...
parser.add_argument('--MAE_WEIGHTAGE', type=float, default=1,
...
object2 = file_creator( model_path = str(output_dir)+str(Variable_name)+'.h5',
                        path_to_forumla_file = str(output_dir)+str(Variable_name)+'.txt')
